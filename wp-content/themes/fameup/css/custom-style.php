...
<style>
    ...
    .widget_block h2, .bs-widget-title .title ,.bs-sec-title .title{ font-family:<?php echo esc_attr(get_theme_mod('fameup_widget_title_fontfamily', 'Vollkorn')); ?> !important; font-size: <?php echo esc_attr(get_theme_mod('sidebar_widgets_title_fontsize')); ?>px !important; }
</style>
