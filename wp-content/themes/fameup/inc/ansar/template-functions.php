    ...
    if ( $fameup_date_time_show_type == 'fameup_default' ) { ?>
        <div class="top-date">
         ...
         <?php if($header_data_enable == true) {
            echo esc_attr(date_i18n('D. M jS, Y ', strtotime(current_time("Y-m-d")))); } ?>
            </span>
